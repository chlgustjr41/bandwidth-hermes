...
// Deserialize given json string into a full diagram object throwing an error if a failure occurs
export function deserialize(json: string) : Diagram {
    const defaultSerializer = new JsonSerializer({
        errorCallback: throwError
    });
    const diagram: Diagram = defaultSerializer.deserializeObject(json, Diagram) as Diagram;
    return diagram;
}
